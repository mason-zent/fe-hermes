...
## 리뷰 대상 레포
- `/Users/mason/mason-zent/client-brics-refund` (refund-fe)
- `/Users/mason/mason-zent/client-brics-hub` (hub-fe)
- `/Users/mason/mason-zent/bznav-web` (bznav-fe)
- `/Users/mason/mason-zent/web-op` (op-fe)
...
- [ ] **레포 규칙 준수**: 해당 레포의 Prettier 설정, 파일 네이밍, `any` 미사용, 미사용 import 없음 (bznav-web은 `.ai/basic-rule.md` 기준)
